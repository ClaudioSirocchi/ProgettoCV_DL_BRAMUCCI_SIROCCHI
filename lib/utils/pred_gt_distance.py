...
def pred_gt_distance(predicted, ground_truth, logger):
    ...
    for prediction in predictions:
        ...
        print('left_arm  : {:.3f}'.format(left_arm_err))
        print('right_arm : {:.3f}'.format(right_arm_err))
        print('left_leg  : {:.3f}'.format(left_leg_err))
        print('right_leg : {:.3f}'.format(right_leg_err))
    ...
    logger.info('left_arm  : {:.3f}'.format(left_arm.avg))
    logger.info('right_arm : {:.3f}'.format(right_arm.avg))
    logger.info('left_leg  : {:.3f}'.format(left_leg.avg))
    logger.info('right_leg : {:.3f}'.format(right_leg.avg))
    logger.info('Total     : {:.3f}'.format(total_err.avg))
