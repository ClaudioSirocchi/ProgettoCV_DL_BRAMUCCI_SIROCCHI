...
from .BabyPoseDataset import BabyPoseDataset as baby_pose
from .BabyPoseDataset import BabyPoseRescoreDataset as rescore_babypose
from .BabyPoseKeypoints import BabyPoseKeypoints as baby_pose_kpt
from .transforms import build_transforms
from .target_generators import HeatmapGenerator
from .target_generators import OffsetGenerator


def build_dataset(cfg, is_train, validation = False):
...
def make_validation_dataloader(cfg, is_train=True, distributed=False):
    if is_train:
        images_per_gpu = cfg.TRAIN.IMAGES_PER_GPU
        shuffle = True
    else:
    ...
    dataset = build_dataset(cfg, is_train, validation=True)
