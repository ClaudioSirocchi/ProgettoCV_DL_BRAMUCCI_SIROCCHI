...
from utils.pred_gt_distance import pred_gt_distance
...
def main():
    ...
    pred_gt_distance(
        os.getcwd() + '/' + final_output_dir + '/results/keypoints_testregression_results.json',
        os.getcwd() + '/data/babypose/json/babypose_test.json',
        logger
    )
